// lib/test/features/profile/my_profile/presentation/views/profile_view_test.dart
...
// 🌟 Creating Mock for ProfileCubit
...
void main() {
  ...
  // Helper widget builder method to provide the required environment for testing
  ...
  group('ProfileView Widget Tests', () {
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        ).thenReturn(const ProfileState(isLoading: true, data: null));
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        when(
          () => mockProfileCubit.state,
        ).thenReturn(const ProfileState(isLoading: false, data: null));
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        expect(find.text('Ahmed Khodary'), findsOneWidget);
        expect(find.text('01289757455'), findsOneWidget);
