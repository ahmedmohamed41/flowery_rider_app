...
class _ProfileApiClient implements ProfileApiClient {
  ...
  @override
  Future<ProfileResponseModel> getLoggedDriverData() async {
    ...
    final _options = _setStreamType<ProfileResponseModel>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'https://flower.elevateegy.com/api/v1/drivers/profile-data',
  ...
  Future<ProfileResponseModel> editProfile(
    ...
    final _options = _setStreamType<ProfileResponseModel>(
      Options(method: 'PUT', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'https://flower.elevateegy.com/api/v1/drivers/editProfile',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
