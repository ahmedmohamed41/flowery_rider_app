...
import 'package:flowery_rider_app/config/security_storage/security_storage.dart';
import 'package:flowery_rider_app/features/profile/my_profile/domain/use_cases/get_logged_driver_data_use_case.dart';
...
class ProfileCubit extends BaseCubit<ProfileState, BaseEvent> {
  ...
  Future<void> _getLoggedDriverData() async {
    ...
    _secureStorage.setSecuredString(
      'token',

      'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJkcml2ZXIiOiI2YTJmNjQzYjk5MjYxMmFlNTk5YTg3YzUiLCJpYXQiOjE3ODI2ODg0NjV9.uYUX1Q1tkPpPfn0a8B6GVp-rzsZqTj9zrD94al9we8Q',
    );
