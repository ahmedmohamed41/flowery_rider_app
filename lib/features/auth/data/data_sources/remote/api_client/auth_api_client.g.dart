...
class _AuthApiClient implements AuthApiClient {
  ...
  @override
  Future<ApplyResponseModel> applyAsDriver(FormData formData) async {
    final _extra = <String, dynamic>{'noToken': true};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = formData;
    final _options = _setStreamType<ApplyResponseModel>(
      Options(
            method: 'POST',
            headers: _headers,
            extra: _extra,
          ...
          .compose(
            _dio.options,
            'https://flower.elevateegy.com/api/v1/drivers/apply',
